...
public:
  ...
  enum Register : uint32_t {
    ...
    REG_STATUS = 0x0004 / 4,
    REG_FORMAT = 0x0010 / 4,
    REG_SAMPLE_RATE = 0x0018 / 4,
    REG_PLAY_BASE = 0x0100 / 4,
    REG_PLAY_PTR = 0x0108 / 4,
    REG_PLAY_END = 0x0110 / 4,
    REG_PLAY_CTRL = 0x0118 / 4,
    REG_REC_BASE = 0x0200 / 4,
    REG_REC_PTR = 0x0208 / 4,
    REG_REC_END = 0x0210 / 4,
    REG_REC_CTRL = 0x0218 / 4,
    REG_VOLUME = 0x0300 / 4,
    REG_INT_STATUS = 0x0400 / 4,
    REG_INT_MASK = 0x0408 / 4,
    REG_INT_CLEAR = 0x0410 / 4,
    REG_REVISION = 0x0FFC / 4,
    SIZE = 0x1000,
  };
